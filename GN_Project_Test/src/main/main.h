...
int getNewFrequencyAvailable()
{
	return newFrequencyAvailable;
}

void resetNewFrequencyAvailable()
{
...
static void ADE9039_Init(void)
{
  ...
  ADE9039_WriteReg(0x060, 0x0000);	// Set INTEN low (disables integrator)
  ADE9039_WriteReg(0x405, 0x0000);	// Set CF3/4 low no interrupts needed for CF3/4	(bits 13 / 14)
  ADE9039_WriteReg(0x481, 0x0000);	// Set CF3/4_CFG to output the digital to frequency counter (bits 1 / 3:2)
  ADE9039_WriteReg(0x490, 0x0080);	// Set CF3/4SEL to apparent / active (real) power (bits 8:6 / 11:9)
  ADE9039_WriteReg(0x491, 0x0440);	// Set TERMSEL3/4 (bits 8:6 / 11:9)
  //ADE9039_WriteReg(0x496, 0x0002);	// Set CF3 denominator NOT LISTED IN REG MAP
  //ADE9039_WriteReg(0x497, 0x0002);	// Set CF4 denominator NOT LISTED IN REG MAP
}
/* --------------------------------------------------------------- */
/**
