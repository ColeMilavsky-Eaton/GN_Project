...
void gpio_init_component(void)
{
...
#else
    UNUSED(DATA_COLLECT_TIMING_Pin, DATA_COLLECT_TIMING_GPIO_Port);
    UNUSED(ZCD_TIMING_Pin, ZCD_TIMING_GPIO_Port);
    UNUSED(MAIN_TIMING_Pin, MAIN_TIMING_GPIO_Port);
#endif
    ...
    ****************************************************/
    /**/
    UNUSED(UNUSED_PB9_Pin, UNUSED_PB9_GPIO_Port);
    UNUSED(UNUSED_PB1_Pin, UNUSED_PB1_GPIO_Port);
    UNUSED(UNUSED_PC14_Pin, UNUSED_PC14_GPIO_Port);
    UNUSED(UNUSED_PA9_Pin, UNUSED_PA9_GPIO_Port);
